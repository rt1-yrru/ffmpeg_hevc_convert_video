#!/usr/bin/env python3
"""
HV_OP - V2.8: Dual Audio Candidate Engine + 6-Gate Sequential Verification
---------------------------------------------------------------------------
Philosophy : Absolute automation. Encodes HEVC once, then races opus vs copy
             audio. Winner verified through 6 sequential gates before source fate
...
class AutomatedHvOpEngine:
    ...
    def run(self):
        ...
        console.print(Panel(
            f"[bold green]▶ HV_OP V2.8 — DUAL AUDIO RACE + 6-GATE SEQUENTIAL VERIFICATION[/]\n"
        ...
        table = Table(
            title="HV_OP V2.8 — Dual Audio Race + 6-Gate Verification Matrix",
